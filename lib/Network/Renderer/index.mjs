...
const Renderer = {
  render(DOMParent, network, trainData) {
    ...
    DOMUIContainer.appendChild(startButton)
    DOMUIContainer.appendChild(stopButton)
    DOMUIContainer.appendChild(inputData)
    DOMUIContainer.appendChild(feedButton)
    DOMContainer.appendChild(DOMUIContainer)
  }
}
